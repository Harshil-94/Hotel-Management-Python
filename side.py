class hotelfarecal:
        ...
        def __init__(self,rt='',e=" ",s=0,p=0,age=0,phn=0,r=0,t=0,a=1800,name='',address='',cindate='',coutdate='',rno=101):
            print ("\n\n*****WELCOME TO WEBSTONE HOTEL*****\n")
        ...
        def display(self):
            ...
            mycursor.execute("insert into customer values('{}','{}','{}','{}','{}','{}')".format(self.name,self.address,self.age,self.e,self.phn,self.cindate,coutdate))
            mydb.commit()
